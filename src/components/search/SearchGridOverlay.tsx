...
interface SearchGridOverlayProps {
  initialQuery?: string
...
export function SearchGridOverlay({ initialQuery = '', onPlay, onMoreInfo, onAddToList, onClose }: SearchGridOverlayProps) {
...
export default SearchGridOverlay